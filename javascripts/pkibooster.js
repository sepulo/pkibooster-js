 ...
 * <p/>
 * This file is part of PKI Booster.
 * <p/>
 * PKI Booster can not be copied and/or distributed without the express
 * permission of owner.
 */
...
function loadCerFromBase64(base64) {
    var cert = new _Certificate();
    cert._loadFromBase64(base64);
    return cert;
}
